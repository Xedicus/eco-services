...
// Code pour afficher et gérer les services
?>
...
<head>
    ...
    <title>Gérer Services - Eco-Services</title>
...
<body>
    ...
    <main class="container py-5">
        <h2 class="text-center">Gérer Services</h2>
        <p class="text-center">Ici, vous pouvez ajouter, modifier ou supprimer des services.</p>
    </main>
