...
// Code pour afficher et gérer les utilisateurs
?>
...
<head>
    ...
    <title>Gérer Utilisateurs - Eco-Services</title>
...
<body>
    ...
    <main class="container py-5">
        <h2 class="text-center">Gérer Utilisateurs</h2>
        <p class="text-center">Ici, vous pouvez afficher et gérer les utilisateurs du site.</p>
    </main>
